// Package clients provides clients for external services like GitHub or OPA
package clients
...
func NewGitHubClient(ctx context.Context) *GitHubClient {
	client := github.NewClient(
		nil, // Use nil for unauthenticated requests; replace with an authenticated client if needed.
	)
