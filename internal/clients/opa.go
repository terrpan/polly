...
// OPAClient provides methods to interact with an Open Policy Agent (OPA) server.
// It holds the base URL of the OPA server and an HTTP client for making requests.
...
// GetOpaHealth checks the health of the OPA server.
